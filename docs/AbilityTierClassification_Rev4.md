...
Each formula reflects the vanilla character who defined that archetype.
Negative terms are intentional — they make formulas exclusive and prevent
a single high-stat character from dominating every slot type.

| Slot Type | Score Formula | Character Inspiration |
|---|---|---|
| Blk Mag | Magic×2 − Dex | Vivi: devastating magic, but timid and slow to act |
| Wht Mag-A | Magic×2 − Strength | Garnet: gentle healer, physically the weakest party member |
| Wht Mag-B | Magic×2 + Will | Eiko: spirited and determined, Will amplifies her conviction |
| Summon-A | Magic + Will − Strength | Garnet-style summoner: measured and elegant, not a fighter |
| Summon-B | Magic + Will×2 − Dex | Eiko-style summoner: passionate and headstrong, Will dominates |
| Blu Mag | Magic + Will − Dex | Quina: magically versatile and tanky, but slow |
| Knight | Strength×2 + Will − Dex | Steiner: immovable tank, rigid and loyal, not nimble |
| Jump | Dex + Strength + Will | Freya: perfectly balanced — agile, strong, and iron-willed |
| Dragon | Will×2 − Dex | Ancient wisdom and endurance; slow but spiritually powerful |
| Flair | Strength + Will×2 − Magic | Amarant: raw power and stubborn spirit; dislikes magic |
| Throw | Dex×2 + Strength − Magic | Pure physical precision; agility and force, no magic needed |
| Focus | Magic + Will − Strength | Concentration requires aptitude and spirit, not brawn |

**Key properties of this table:**
- All magic formulas are distinct — no two magic slots score identically
- Dragon ignores Strength intentionally — Dragon's Crest scales off kill count, not Str
- Dragon and Flair both prize Will heavily, creating real competition for high-Will characters
- A high-Magic character is penalized for Knight, Throw, Flair, Dragon
- A high-Strength character is penalized for Blk Mag, Wht Mag-A, Summon-A, Focus
